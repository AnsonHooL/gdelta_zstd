 ...
 */
#ifndef GDELTA_DECOMPRESS_H
#define GDELTA_DECOMPRESS_H
...
void gdelta_decompress_litandseq(void *deltaBuf, uint32_t deltasize, void *lit, void *seq, uint32_t *litsize,
                                 uint32_t *seqnum,uint32_t inputsize);
#endif
